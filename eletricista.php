<?php
    ...
    $servico2 = new Servico("Eletricista","Instalar aterramento",85.59);
    $servico3 = new Servico("Eletricista","Fazer gato de energia",85.59);
    $servicosEletricista = array($servico0,$servico1,$servico2,$servico3);
...
<head>
    ...
    <title>Serviço Fácil | Eletricista</title>
...
<body>
    ...
    <section class="call">
        <div class="call--container container-3">
            <div class="call--container--content">
                <h1 class="call__title">Em busca de profissionais em Eletricistas ?</h1>
    ...
    <section class="services">
        <div class="services--container container-3">
            <h1 class="services__title">Serviços de Eletricista</h1>
            <form action="servicos-confirmar.php" method="post" class="services__form">
                <select name="servicos" id="servicos" class="services__select">
                    <?php
                        exibirServicos($servicosEletricista);
                    ?>
                </select>
