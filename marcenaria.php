<?php
    ...
    $servico1 = new Servico("Marcenaria","Conserto de móveis de MDF",99.99);
    $servico2 = new Servico("Marcenaria","Conserto de móveis de madeira",85.59);
    $servico3 = new Servico("Marcenaria","Restauração de móveis antigos",55.70);
    $servico4 = new Servico("Marcenaria","Impermebialização de madeiras",45.10);
    $servicosMarcenaria = array($servico0,$servico1,$servico2,$servico3,$servico4);
...
<head>
    ...
    <title>Serviço Fácil | Marcenaria</title>
...
<body>
    ...
    <section class="call">
        <div class="call--container container-3">
            <div class="call--container--content">
                <h1 class="call__title">Em busca de profissionais em Marcenaria ?</h1>
    ...
    <section class="services">
        <div class="services--container container-3">
            <h1 class="services__title">Serviços de Marcenaria</h1>
            <form action="servicos-confirmar.php" method="post" class="services__form">
                <select name="servicos" id="servicos" class="services__select">
                    <?php
                        exibirServicos($servicosMarcenaria);
                    ?>
                </select>
